    ...
    <section id="Contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-4 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 actyive:bg-zinc-50/80 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/agdlpxob"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="nabilbabu@gmail.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
          <div className="mb-4">
            <label htmlFor="messege" className="label reveal-up">
              Messege
            </label>
            <textarea
              name="messege"
              id="messege"
              required
              className="text-field resize-y miin-h-32 h-32 max-h-80 reveal-up"
              placeholder="Hi!"
            ></textarea>
          </div>
